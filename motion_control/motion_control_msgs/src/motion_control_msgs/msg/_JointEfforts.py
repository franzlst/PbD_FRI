"""autogenerated by genpy from motion_control_msgs/JointEfforts.msg. Do not edit."""
import sys
...
class JointEfforts(genpy.Message):
  _md5sum = "b6430b8ec0693b7af8da0bcb29973d67"
  _type = "motion_control_msgs/JointEfforts"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string[] names
float64[] efforts

"""
  __slots__ = ['names','efforts']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointEfforts, self).__init__(*args, **kwds)
